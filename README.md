...
- `picks` — комбинация базовых пакетов Spark (60/325/660/1800/3850/8100), заданная у лота, умноженная на количество из заказа. Напр. лот «445 UC» = `{"325":1,"60":2}`, при заказе ×2 → `{"325":2,"60":4}`. Один UID — один запрос со всей комбинацией.
